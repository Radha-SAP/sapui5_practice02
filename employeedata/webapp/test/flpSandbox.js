		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#arcomemployeedata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomemployeedata-display": {
								"semanticObject": "arcomemployeedata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.employeedata",
									"url": sap.ui.require.toUrl("ar/com/employeedata")
								}
							}
						}
					}
