		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Project Task",
									"targetURL": "#arcomcustomerproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomcustomerproject-display": {
								"semanticObject": "arcomcustomerproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.customerproject",
									"url": sap.ui.require.toUrl("ar/com/customerproject")
								}
							}
						}
					}
