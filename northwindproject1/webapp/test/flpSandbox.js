		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#arcomnorthwindproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomnorthwindproject1-display": {
								"semanticObject": "arcomnorthwindproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.northwindproject1",
									"url": sap.ui.require.toUrl("ar/com/northwindproject1")
								}
							}
						}
					}
