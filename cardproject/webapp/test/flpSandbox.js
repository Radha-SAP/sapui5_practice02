		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Card Project",
									"targetURL": "#arcomcardproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomcardproject-display": {
								"semanticObject": "arcomcardproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.cardproject",
									"url": sap.ui.require.toUrl("ar/com/cardproject")
								}
							}
						}
					}
