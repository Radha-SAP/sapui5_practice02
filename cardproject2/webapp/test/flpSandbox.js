		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Show Business PartnerDetails",
									"targetURL": "#arcomcardproject2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomcardproject2-display": {
								"semanticObject": "arcomcardproject2",
								"action": "display",
								"description": "Show Business PartnerDetails",
								"title": "Show Business PartnerDetails",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.cardproject2",
									"url": sap.ui.require.toUrl("ar/com/cardproject2")
								}
							}
						}
					}
