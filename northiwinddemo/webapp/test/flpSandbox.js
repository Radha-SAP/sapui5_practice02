		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 Learn via Northwind",
									"targetURL": "#arcomnorthiwinddemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomnorthiwinddemo-display": {
								"semanticObject": "arcomnorthiwinddemo",
								"action": "display",
								"description": "Northwind Demo",
								"title": "UI5 Learn via Northwind",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.northiwinddemo",
									"url": sap.ui.require.toUrl("ar/com/northiwinddemo")
								}
							}
						}
					}
