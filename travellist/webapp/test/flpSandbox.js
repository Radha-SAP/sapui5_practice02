		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Display Travels",
									"targetURL": "#arcomtravellist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomtravellist-display": {
								"semanticObject": "arcomtravellist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.travellist",
									"url": sap.ui.require.toUrl("ar/com/travellist")
								}
							}
						}
					}
