		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#arcomnorthwindtablecount-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomnorthwindtablecount-display": {
								"semanticObject": "arcomnorthwindtablecount",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.northwindtablecount",
									"url": sap.ui.require.toUrl("ar/com/northwindtablecount")
								}
							}
						}
					}
