		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Travel Display",
									"targetURL": "#arcomtravelbooking-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcomtravelbooking-display": {
								"semanticObject": "arcomtravelbooking",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.com.travelbooking",
									"url": sap.ui.require.toUrl("ar/com/travelbooking")
								}
							}
						}
					}
